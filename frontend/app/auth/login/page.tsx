...
import { Heart, Mail, Lock, Eye, EyeOff, ArrowRight, Clock } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-500 mb-8">
            ...
            <Link href="/auth/register" className="text-sky-600 font-medium hover:underline">S'inscrire gratuitement</Link>
          </p>
